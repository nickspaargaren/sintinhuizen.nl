...
3. Click "Commit changes" and add a short description
...
Open an issue on [GitHub](https://github.com/nickspaargaren/sintinhuizen.nl/issues) or contact the project maintainers.
