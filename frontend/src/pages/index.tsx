      ...
      <>
          ...
          <StyledHeader className="grid-2x">
            <div className="headerintro">
              <div>
                <h1>
                  ...
                  <strong>Sint Nicolaas</strong> <small>komt</small>{" "}
                  <span>18 november 2023</span> <small>aan in</small>{" "}
            ...
            <div className="illustration">
              ...
              <h3>
                ...
                zuinig op <strong>het boek</strong>, want als het kwijtraakt,
                weet hij niet waar de <strong>cadeautjes</strong> naartoe
                moeten!
              </h3>
            </div>
          </StyledHeader>
        ...
        <section className="bericht">
          <div className="grid-2x">
            <div
              dangerouslySetInnerHTML={{ __html: berichtsint?.html || "" }}
            />
              ...
              <div>
                <div className="text">
                  <p>
                    ...
                    levenslang glutenvrij dieet volgen. De intocht van
                    Sinterklaas is voor hen niet altijd feestelijk. Ze mogen de
                    kruidnoten niet eten en highfiven met de Pieten gaat ook al
                    niet, want van kruimels op de handschoen worden zij al ziek.
                  </p>
                  <p>
                ...
                <div className="text">
                  <p>
                    ...
                    Glutenvrije Piet dat jij de glutenvrije kruidnoten mag
                    hebben! Je kunt ook de kleurplaat downloaden, inkleuren en
                    omhoog houden. Verwacht je slecht weer? Dan is lamineren een
                    uitkomst.
                  </p>
                  <Button
              ...
              <div>
                <div className="text">
                  <p>
                    ...
                    ander snoepgoed. De Glutenvrije Piet houdt een vlag omhoog
                    met het Glutenvrije Piet logo erop. Je herkent hem dus
                    zeker!
                  </p>
                </div>
                <div className="rotatedImage">
        ...
        <section className="photos">
          <div>
            ...
            <p style={{ textAlign: "center", margin: "-15px 0 40px" }}>
